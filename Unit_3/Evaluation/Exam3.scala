...
val WSSE = model.computeCost(output)//WSSE: Double = 8.095172370767671E10
println(s"Within set sum of Squared Errors = $WSSE")//Within set sum of Squared Errors = 8.095172370767671E10
